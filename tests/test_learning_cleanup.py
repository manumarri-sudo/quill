...
def test_find_stale_patterns_identifies_token_rows_only(
    ...
    _seed_stats(tmp_path, {
        "Bash:rm -rf": {
            ...
            "fires": 50, "approvals": 5, "denies": 45,
            "consecutive_denies": 5, "consecutive_approvals": 0,
            "ewma_approval_rate": 0.1, "inter_arrival_sec": [],
            "last_fire_ts": 0, "first_fire_ts": 0,
        },
        "Bash:approved one-shot via quill approve aBcDeFg1": {
            "pattern_id": "Bash:approved one-shot via quill approve aBcDeFg1",
            "fires": 1, "approvals": 1, "denies": 0,
            "consecutive_denies": 0, "consecutive_approvals": 1,
            "ewma_approval_rate": 0.1, "inter_arrival_sec": [],
            "last_fire_ts": 0, "first_fire_ts": 0,
        },
        ...
        "Edit:high risk: default risk for Edit": {
            ...
            "fires": 100, "approvals": 0, "denies": 100,
            "consecutive_denies": 100, "consecutive_approvals": 0,
            "ewma_approval_rate": 0.0, "inter_arrival_sec": [],
            "last_fire_ts": 0, "first_fire_ts": 0,
        },
        ...
        "Bash:git commit -m 'we use approved one-shot tokens here'": {
            ...
            "fires": 1, "approvals": 0, "denies": 1,
            "consecutive_denies": 1, "consecutive_approvals": 0,
            "ewma_approval_rate": 0.0, "inter_arrival_sec": [],
            "last_fire_ts": 0, "first_fire_ts": 0,
        },
    })
