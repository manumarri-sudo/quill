"""ISO 22324 + NIST/CIS-aligned severity-color treatment for Notari CLI output.

The standard mapping is uniform across `notari saves`, `notari insights`,
`notari watch`, and any future surface that needs to communicate "what just
...
# them with consistent width (drifts the table alignment in `notari insights`).
